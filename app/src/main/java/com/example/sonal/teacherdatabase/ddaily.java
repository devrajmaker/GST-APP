...
public class ddaily extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_ddaily);
    ...
    private void ListView_Event() {
        ...
        listView.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> parent, View view,
                ...
                Intent intent=new Intent(ddaily.this,Cart.class);
                startActivity(intent);
    ...
    private class AsyncTaskRunner extends AsyncTask<String, String, String> {
        ...
        protected String doInBackground(String... params) {
            ...
            try {
                ...
                resp = web.sendCompleteData(null, null, "daily_retrieve");
                //
        ...
        protected void onPreExecute() {
            ...
            progressDialog = ProgressDialog.show(ddaily.this,"Process","Please wait...");
        }
        @Override
