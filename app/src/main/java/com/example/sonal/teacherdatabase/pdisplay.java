...
public class pdisplay extends AppCompatActivity {
    ...
    private void ListView_Event() {
        ...
        listView.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> parent, View view,
                ...
                Intent intent=new Intent(pdisplay.this,pdetail.class);
                startActivity(intent);
    ...
    private class AsyncTaskRunner extends AsyncTask<String, String, String> {
        ...
        protected String doInBackground(String... params) {
            ...
            try {
                ...
                resp = web.sendCompleteData(null, null, "product_retrieve");
                //
        ...
        protected void onPreExecute() {
            ...
            progressDialog = ProgressDialog.show(pdisplay.this,"Process","Please wait...");
        }
        @Override
