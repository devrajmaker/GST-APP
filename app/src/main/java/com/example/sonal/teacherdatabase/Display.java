    ...
    private void ListView_Event() {
        ...
        listView.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> parent, View view,
                ...
                Intent intent=new Intent(Display.this,User_Detail.class);
                startActivity(intent);
    ...
    public void selectAllDatesExists(String json)
    {
        ...
        try {
            ...
            for(int i=0; i<ja.length(); i++) {
                ...
                common.para2=password;//created_date
                common.para3=phoneno;//notice_desc
                common.para4=email;
    ...
    private class AsyncTaskRunner extends AsyncTask<String, String, String> {
        ...
        protected String doInBackground(String... params) {
            ...
            try {
                ...
                resp = web.sendCompleteData(null, null, "user_retrieve");
                //
        ...
        protected void onPreExecute() {
            ...
            progressDialog = ProgressDialog.show(Display.this,"Process","Please wait...");
        }
        @Override
