...
public class dothers extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_dothers);

        setTitle("OTHERS DETAILS");
    ...
    private void ListView_Event() {
        ...
        listView.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> parent, View view,
                ...
                Intent intent=new Intent(dothers.this,Cart.class);
                startActivity(intent);
    ...
    private class AsyncTaskRunner extends AsyncTask<String, String, String> {
        ...
        protected String doInBackground(String... params) {
            ...
            try {
                ...
                resp = web.sendCompleteData(null, null, "others_retrieve");
                //
        ...
        protected void onPreExecute() {
            ...
            progressDialog = ProgressDialog.show(dothers.this,"Process","Please wait...");
        }
        @Override
