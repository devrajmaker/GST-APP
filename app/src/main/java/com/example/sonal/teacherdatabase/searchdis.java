...
public class searchdis extends AppCompatActivity {
    ...
    {
        //Config1.page="Add";
        Intent intent=new Intent(this,productfill.class);
    ...
    private void ListView_Event() {
        ...
        listView.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> parent, View view,
                ...
                Intent intent=new Intent(searchdis.this,pdetail.class);
                startActivity(intent);
    ...
    public void selectAllDatesExists(String json)
    {
        ...
        try {
            ...
            for(int i=0; i<ja.length(); i++) {
                ...
                common.para1=pid;//notice_title
                common.para2=pname;//created_date
    ...
    private class AsyncTaskRunner extends AsyncTask<String, String, String> {
        ...
        protected String doInBackground(String... params) {
            ...
            try {
                ...
                String names[]={"P_name"};
                System.out.println("bags"+Config1.pname);

               String values[]={Config1.pname};
                resp = web.sendCompleteData(names, values, "product_search");
                //
        ...
        protected void onPreExecute() {
            ...
            progressDialog = ProgressDialog.show(searchdis.this,"Process","Please wait...");
        }
        @Override
